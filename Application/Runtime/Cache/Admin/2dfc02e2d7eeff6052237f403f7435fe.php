...
<section id="main" class="column">
		...
		<h4 class="alert_info">欢迎来到阳关家园后台管理系统</h4>
		...
		<form action="/hzauygjy/index.php/admin/news/upload" enctype="multipart/form-data" method="post" id="newform">
			<header><h3>添加新闻</h3></header>
