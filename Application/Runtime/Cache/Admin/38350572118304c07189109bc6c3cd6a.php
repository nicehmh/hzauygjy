...
<section id="main" class="column">
	...
	<form class="form-horizontal" role="form" method="post" action="/hzauygjy/index.php/admin/people/record" enctype="multipart/form-data">
   <div class="form-group">
      <label for="firstname" class="col-sm-2 control-label">姓&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp名</label>
      <div class="col-sm-10">
         <input type="text" class="form-control" id="firstname" name="name"  placeholder="请输入姓名">
      </div>
   </div>
   <div class="form-group">
      <label for="lastname" class="col-sm-2 control-label">曾任职务</label>
      <div class="col-sm-10">
         <input type="text" class="form-control" id="lastname" name="job"     placeholder="请输入职务">
      </div>
   </div>
   <div class="form-group">
